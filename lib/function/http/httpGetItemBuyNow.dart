...
Future<GetItemInBasket_ItemsResponse> HttpGetItemBuyNow(
    {@required GetItemBuyNowRequest bufferGetItemBuyNowRequest}) async {
  var body = bufferGetItemBuyNowRequest.value();

  var url = Uri.parse("${HostName()}/foodbuy/getItemBuyNow");
